...
class AcademicSiteSourceTest(unittest.TestCase):
    ...
    def test_contact_links_are_icon_links_at_homepage_bottom(self):
        ...
        self.assertIn('class="fa-brands fa-linkedin"', about)
        ...
        self.assertIn('href="https://www.linkedin.com/in/miaoqian-lin-2565b7332/"', about)
    ...
    def test_homepage_lists_academic_services_before_contact_links(self):
        about = read("_pages/about.md")
