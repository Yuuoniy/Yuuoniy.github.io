...
nav: true
nav_order: 2
description: Below are some materials that may help.
hide_title: true
_styles: |
  .post-description { font-size: 1rem; margin-bottom: 1.5rem; }
  .misc-section-heading { font-size: 1rem; font-weight: 600; margin-top: 1.4rem; margin-bottom: 0.6rem; }
---

<h3 class="misc-section-heading">Research</h3>
